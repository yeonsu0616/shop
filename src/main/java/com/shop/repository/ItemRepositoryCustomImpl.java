...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{
    private JPAQueryFactory queryFactory; //동작쿼리 사용하기 위해 JPAQueryFactory 변수 선언
    //생성자
    ...
    private BooleanExpression searchSellStatusEq(ItemSellStatus searchSellStatus){
        ...
        //ItemSellStatus null이면 null리턴. null아니면 Sell,Sold 둘 중 하나 리턴
    }
    ...
    public Page<MainItemDto> getMainItempage(ItemSearchDto itemSearchDto, Pageable pageable){
        ...
        //select i.id,id.itemNm ,i.itemNm,i.itemDetail,i.itenImg , i.price, from i, itemimg im join i.id = i,.itemid
        //where im.reImgYn = "Y" and i.itemNm like %searchQuery% order by i.id desc
        //QMainItemDto @QueryProjection을 허용하면 DTO호 바로 조회 가능
        QueryResults<MainItemDto>results = queryFactory.select(new QMainItemDto(item.id,item.itemNm,
                ...
                //join 내부조인 . regImgYn.eq("Y")대표적이미지만 가져옴
